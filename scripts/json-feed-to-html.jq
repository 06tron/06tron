._prefix_for_tag_urls as $tag_prefix | [
	...
	.description,
	"'/><meta name='format-detection' content='telephone=no'/><meta name='viewport' content='width=device-width'/><base href='../../'/><link rel='icon' href='",
	.icon,
	...
	"'>",
	.title,
	"</a></h1><p><time class='dt-updated'>",
	._atom_elements.updated,
	"</time></p></hgroup><p class='p-summary'>",
	.description,
	...
	(.items | length as $len | to_entries[] | [
		...
		"'>",
		.value.title,
		"</a></h2><p><time class='dt-published'>",
		.value.date_published,
		"</time></p></hgroup><div class='e-content'>",
		.value.content_html,
